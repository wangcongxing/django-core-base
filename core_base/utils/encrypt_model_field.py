...
class RsaUtil(object):
    PUBLIC_KEY_PATH = os.path.join(config.BASE_DIR, 'core_base/initConf/company_rsa_public_key.pem')  # 公钥
    PRIVATE_KEY_PATH = os.path.join(config.BASE_DIR, 'core_base/initConf/company_rsa_private_key.pem')  # 私钥
